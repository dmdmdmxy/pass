...
DDNS_RAW_URL="https://raw.githubusercontent.com/dmdmdmxy/ddns/refs/heads/main/pass-hk17-DNS.sh"

# 2. 下载后放置的目标路径：
DDNS_SCRIPT_TARGET="/usr/local/bin/ddns_update.sh"

# 3. 原 install.sh 脚本下载地址（保持原先逻辑不变）：
INSTALL_SH_URL="http://ytpass.fxscloud.com:666/client/LFdPjDU8MV8RLe8g/install.sh"
